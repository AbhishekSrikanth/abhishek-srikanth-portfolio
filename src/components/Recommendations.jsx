    ...
    return (
        <div className='h-full'>
            <div className='flex space-x-5 w-full justify-between h-5/6 px-10'>
                <button
                    className='bg-black text-white border-white border-2 p-2 rounded-full disabled:bg-black disabled:border-gray-700 disabled:text-gray-700 h-16 w-16 my-auto hover:text-black hover:bg-white'
                ...
                <div className='bg-white p-7 rounded-lg w-3/4 h-full overflow-scroll'>
                    <div className='flex justify-between'>
                        ...
                        <a className="text-4xl text-indigo-950" href="https://www.linkedin.com/in/abhishek-srikanth-803734173/details/recommendations" target="_blank" rel="noreferrer" ><FontAwesomeIcon icon="fa-brands fa-linkedin" /></a>
                    </div>
